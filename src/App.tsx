    ...
    <>
      <form className={isQuickAdd ? 'entry-form' : 'glass-panel entry-form'} onSubmit={handleSubmit}>
        ...
        <div className="form-grid" style={{ gridTemplateColumns: 'repeat(2, minmax(0, 1fr))' }}>
          ...
          <div className="content-entry-cell-wrapper" style={{ gridColumn: 'span 2' }}>
            {isTitleSuggestionsOpen && titleSuggestions.length > 0 ? (
              <div className="content-entry-unified-expanded-card" onClick={(e) => e.stopPropagation()}>
                ...
                <label className="unified-input-row" aria-label="내용">
                  <input
                    type="text"
                    ref={titleRef}
